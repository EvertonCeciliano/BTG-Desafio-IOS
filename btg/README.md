...
## Features
### Obrigatórias:
- [x] As taxas de câmbio disponíveis devem ser obtidas da chamada de [API Supported Currencies (/list)](https://documenter.getpostman.com/view/11242574/2sA3Qqgt3W)
- [x] A cotação atual deve ser obtida da chamada de [API Real-time Rates (/live)](https://documenter.getpostman.com/view/11242574/2sA3Qqgt3W)
